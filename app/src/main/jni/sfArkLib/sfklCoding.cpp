...
// ==============================================================
int InvalidEncodeCount(int EncodeCount, int MaxLoops)
{
...
// ==============================================================
int CheckShift(short *ShiftVal, USHORT NumWords, short *PrevShift, short *PrevUsedShift)
...
// For non-zero shift value, we then need to leftshift the data by that number of bits.
{
  ...
  int UsingShift = BioReadFlag();		// Read flag to see if using any shift
